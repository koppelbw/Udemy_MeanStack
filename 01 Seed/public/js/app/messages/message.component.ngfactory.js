...
var _View_MessageComponent0 = (function (_super) {
    ...
    _View_MessageComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_13 = this.renderer.createText(this._el_12, 'Edit', null);
        this._text_14 = this.renderer.createText(this._el_10, '\n            ', null);
        this._el_15 = this.renderer.createElement(this._el_10, 'a', null);
        this._text_16 = this.renderer.createText(this._el_15, 'Delete', null);
    ...
    _View_MessageComponent0.prototype._handle_click_12_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.onEdit() !== false);
        return (true && pd_0);
    };
    _View_MessageComponent0.prototype._handle_click_15_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
...
export function viewFactory_MessageComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageComponent === null)) {
        (renderType_MessageComponent = viewUtils.createRenderComponentType('D:/MyPc/Users/Bill/Documents/Personal_Projects/Udemy/Udemy_MeanStack/01 Seed/assets/app/messages/message.component.html', 0, import9.ViewEncapsulation.Emulated, styles_MessageComponent, {}));
    }
