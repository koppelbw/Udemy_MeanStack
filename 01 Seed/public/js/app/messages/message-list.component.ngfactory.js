...
export function viewFactory_MessageListComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageListComponent === null)) {
        (renderType_MessageListComponent = viewUtils.createRenderComponentType('D:/MyPc/Users/Bill/Documents/Personal_Projects/Udemy/Udemy_MeanStack/01 Seed/assets/app/messages/message-list.component.ts class MessageListComponent - inline template', 0, import9.ViewEncapsulation.None, styles_MessageListComponent, {}));
    }
...
var _View_MessageListComponent1 = (function (_super) {
    ...
    _View_MessageListComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import14.MessageComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
