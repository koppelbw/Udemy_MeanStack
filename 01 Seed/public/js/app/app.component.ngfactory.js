    ...
    Object.defineProperty(_View_AppComponent_Host0.prototype, "_MessageService_0_5", {
        get: function () {
            if ((this.__MessageService_0_5 == null)) {
                (this.__MessageService_0_5 = new import4.MessageService(this.parentInjector.get(import9.Http)));
            }
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import14.viewFactory_HeaderComponent0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        this._RouterOutlet_6_5 = new import13.RouterOutlet(this.parentInjector.get(import15.RouterOutletMap), this._appEl_6.vcRef, this.parentInjector.get(import16.ComponentFactoryResolver), null);
...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('D:/MyPc/Users/Bill/Documents/Personal_Projects/Udemy/Udemy_MeanStack/01 Seed/assets/app/app.component.html', 0, import10.ViewEncapsulation.None, styles_AppComponent, {}));
    }
