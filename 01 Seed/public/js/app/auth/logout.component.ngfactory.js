...
function viewFactory_LogoutComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LogoutComponent_Host === null)) {
        (renderType_LogoutComponent_Host = viewUtils.createRenderComponentType('', 0, import8.ViewEncapsulation.None, [], {}));
    }
    return new _View_LogoutComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var LogoutComponentNgFactory = new import9.ComponentFactory('app-logout', viewFactory_LogoutComponent_Host0, import3.LogoutComponent);
...
export function viewFactory_LogoutComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_LogoutComponent === null)) {
        (renderType_LogoutComponent = viewUtils.createRenderComponentType('D:/MyPc/Users/Bill/Documents/Personal_Projects/Udemy/Udemy_MeanStack/01 Seed/assets/app/auth/logout.component.ts class LogoutComponent - inline template', 0, import8.ViewEncapsulation.None, styles_LogoutComponent, {}));
    }
