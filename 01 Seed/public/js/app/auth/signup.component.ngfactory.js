...
function viewFactory_SignupComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SignupComponent_Host === null)) {
        (renderType_SignupComponent_Host = viewUtils.createRenderComponentType('', 0, import8.ViewEncapsulation.None, [], {}));
    }
    return new _View_SignupComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var SignupComponentNgFactory = new import9.ComponentFactory('app-signup', viewFactory_SignupComponent_Host0, import3.SignupComponent);
...
var _View_SignupComponent0 = (function (_super) {
    ...
    _View_SignupComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._FormControlName_25_5 = new import13.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_25_4);
        ...
        this._FormControlName_33_5 = new import13.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_33_4);
    ...
    _View_SignupComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import12.DefaultValueAccessor) && (25 === requestNodeIndex))) {
        ...
        if (((token === import10.FormGroupDirective) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._FormGroupDirective_2_3;
        }
        if (((token === import17.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._ControlContainer_2_4;
        }
        if (((token === import11.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
...
export function viewFactory_SignupComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SignupComponent === null)) {
        (renderType_SignupComponent = viewUtils.createRenderComponentType('D:/MyPc/Users/Bill/Documents/Personal_Projects/Udemy/Udemy_MeanStack/01 Seed/assets/app/auth/signup.component.html', 0, import8.ViewEncapsulation.None, styles_SignupComponent, {}));
    }
